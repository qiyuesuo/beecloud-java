...
public class MockNotify {
    ...
    public static void aliPay(Client client, String outTradeNo, String objectId){
        ...
        param.put("bc_appid", TestConstant.TEST_APP_ID + "_" +  objectId);
        ...
        //check webhook
        boolean webhookResult = TestUtil.webhookCheck(client, outTradeNo, "ALI", TestConstant.TRANSACTION_TYPE_PAY);
